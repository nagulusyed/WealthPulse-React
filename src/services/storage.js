...
const KEYS = {
  ...
  goals:          'wp_goals',
  emis:           'wp_emis',
  netWorth:       'wp_net_worth',
  netWorthHistory:'wp_net_worth_history',
};
...
export const storage = {
  ...
  // Finance & Planning
  getGoals:           () => getJSON(KEYS.goals, []),
  saveGoals:          (items) => setJSON(KEYS.goals, items),
  getEmis:            () => getJSON(KEYS.emis, []),
  saveEmis:           (items) => setJSON(KEYS.emis, items),
  getNetWorth:        () => getJSON(KEYS.netWorth, []),
  saveNetWorth:       (items) => setJSON(KEYS.netWorth, items),
  getNetWorthHistory: () => getJSON(KEYS.netWorthHistory, []),
  saveNetWorthHistory:(items) => setJSON(KEYS.netWorthHistory, items),
